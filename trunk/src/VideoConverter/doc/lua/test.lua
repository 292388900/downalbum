function do_calc(data)
    ...
    for i=1, #data do
			...
			value1 = c_do2(AV_CRC_32_IEEE_LE[idx], value1/256)
    end
    
    if #data>3 then
    	local part1 = max_value and data[1] or data[2]
    	local part2 = part1 and data[3] or data[4]
    	local part3 = part2 and data[5] or data[6]
