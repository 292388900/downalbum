...
function xlSheetGetNamedRange(handle: SheetHandle; const name: PAnsiChar; rowFirst: PInteger; rowLast: PInteger; colFirst: PInteger; colLast: PInteger): Integer cdecl;
...
function xlSheetNamedRange(handle: SheetHandle; index: Integer; rowFirst: PInteger; rowLast: PInteger; colFirst: PInteger; colLast: PInteger): PAnsiChar cdecl;
...
type
  ...
  public
    ...
    function getNamedRange(const name: PAnsiChar; var rowFirst, rowLast, colFirst, colLast: Integer): boolean;
...
begin
  result := xlSheetGetNamedRange(handle, name, @rowFirst, @rowLast, @colFirst, @colLast) > 0;
end;
...
begin
  result := xlSheetNamedRange(handle, index, @rowFirst, @rowLast, @colFirst, @colLast);
end;
