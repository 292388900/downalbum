...
#if !defined(AFX_StaticLink_H__D1625061_574B_11D1_ABBA_00A0243D1382__INCLUDED_)
#define AFX_StaticLink_H__D1625061_574B_11D1_ABBA_00A0243D1382__INCLUDED_
...
protected:
    COLORREF m_crLinkColour, m_crVisitedColour;     // StaticLink colours
    COLORREF m_crHoverColour;                       // Hover colour
    BOOL     m_bOverControl;                        // cursor over control?
    BOOL     m_bVisited;                            // Has it been visited?
    int      m_nUnderline;                          // underline StaticLink?
    BOOL     m_bAdjustToFit;                        // Adjust window size to fit text?
    CFont    m_UnderlineFont;                       // Font for underline display
    CFont    m_StdFont;                             // Standard font
    HCURSOR  m_hLinkCursor;                         // Cursor for StaticLink
    UINT     m_nTimerID;
...
#endif // !defined(AFX_StaticLink_H__D1625061_574B_11D1_ABBA_00A0243D1382__INCLUDED_)
